...
while($reg = $result->fetchObject()){
        ...
        $pdf->Cell(130, 50,'IMAGE', 1);
        $pdf->Ln(50);
        $pdf->SetFont('Arial', 'I', 12);
        $pdf->Cell(50, 10, 'Nombres', 1);
        $pdf->Cell(80, 10,$reg->nombres, 1);
        $pdf->Ln(10);
        $pdf->SetFont('Arial', 'I', 12);
        $pdf->Cell(50, 10, 'Apellido Paterno', 1);
        $pdf->Cell(80, 10,$reg->apellidopaterno, 1);
        $pdf->Ln(10);
        $pdf->SetFont('Arial', 'I', 12);
        $pdf->Cell(50, 10, 'Apellido Materno', 1);
        $pdf->Cell(80, 10, $reg->apellidomaterno, 1);
        $pdf->Ln(10);
        $pdf->SetFont('Arial', 'I', 12);
        $pdf->Cell(50, 10, 'Escuela Pro.', 1);
        $pdf->Cell(80, 10, $reg->escuela, 1);
        $pdf->Ln(10);
        $pdf->SetFont('Arial', 'I', 12);
        $pdf->Cell(50, 10, 'Universidad', 1);
        $pdf->Cell(80, 10, $reg->universidad, 1);
        $pdf->Output(); 
}
?>